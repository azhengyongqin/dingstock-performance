...
-- CreateIndex
CREATE UNIQUE INDEX "lark_users_union_id_key" ON "lark_users"("union_id");

-- CreateIndex
CREATE UNIQUE INDEX "lark_users_user_id_key" ON "lark_users"("user_id");

-- CreateIndex
CREATE INDEX "lark_departments_parent_department_id_idx" ON "lark_departments"("parent_department_id");
